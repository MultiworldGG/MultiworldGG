...
key_item_table: List[ItemInfo] = [
    ...
    ItemInfo(83, ItemName.KeyItem.HotelKey, ItemClassification.progression),
    ItemInfo(84, ItemName.KeyItem.CasinoKey, ItemClassification.progression),
    ItemInfo(85, ItemName.KeyItem.TPTicket, ItemClassification.progression),
    ...
    ItemInfo(121, ItemName.KeyItem.StationKey, ItemClassification.progression),
    ItemInfo(122, ItemName.KeyItem.ShutterKey, ItemClassification.progression),
    ...
    ItemInfo(125, ItemName.KeyItem.PoolKey, ItemClassification.progression),
    ItemInfo(126, ItemName.KeyItem.PolicePass, ItemClassification.progression),
    ItemInfo(127, ItemName.KeyItem.TimeMachine, ItemClassification.progression),
