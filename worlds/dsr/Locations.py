...
"Firelink Shrine - Griggs of Vinheim": [
    ...
    DSRLocationData(11111116, f"Griggs of Vinheim: Sorcerer's Catalyst", f"Sorcerer's Catalyst", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Firelink Shrine - Griggs of Vinheim, After Logan Leaves": [
...
"Firelink Shrine - Petrus of Thorolund": [
    ...
    DSRLocationData(11111118, f"Petrus of Thorolund: Talisman", f"Talisman", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111119, f"Petrus of Thorolund: Thorolund Talisman", f"Thorolund Talisman", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Firelink Shrine - Rhea of Thorolund": [
...
"Firelink Shrine - Domhnall of Zena": [
    ...
    DSRLocationData(11110886, f"Domhnall of Zena Under Aqueduct: Master Key", f"Filler", DSRLocationCategory.SHOP_ITEM), # Removed master key from pool
    DSRLocationData(11111109, f"Domhnall of Zena: Crystal Straight Sword", f"Crystal Straight Sword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111110, f"Domhnall of Zena: Crystal Greatsword", f"Crystal Greatsword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111111, f"Domhnall of Zena: Crystal Shield", f"Crystal Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111112, f"Domhnall of Zena: Helm of the Wise", f"Helm of the Wise", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111113, f"Domhnall of Zena: Armor of the Glorious", f"Armor of the Glorious", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111114, f"Domhnall of Zena: Gauntlets of the Vanquisher", f"Gauntlets of the Vanquisher", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111115, f"Domhnall of Zena: Boots of the Explorer", f"Boots of the Explorer", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Firelink Shrine - Domhnall of Zena After Iron Golem": [
    DSRLocationData(11110866, f"Domhnall of Zena After Iron Golem: Golem Helm", f"Golem Helm", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110867, f"Domhnall of Zena After Iron Golem: Golem Armor", f"Golem Armor", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110868, f"Domhnall of Zena After Iron Golem: Golem Gauntlets", f"Golem Gauntlets", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110869, f"Domhnall of Zena After Iron Golem: Golem Leggings", f"Golem Leggings", DSRLocationCategory.SHOP_ITEM),
],
"Firelink Shrine - Domhnall of Zena After O+S": [
    DSRLocationData(11110870, f"Domhnall of Zena After O+S: Smough's Helm", f"Smough's Helm", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110871, f"Domhnall of Zena After O+S: Smough's Armor", f"Smough's Armor", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110872, f"Domhnall of Zena After O+S: Smough's Gauntlets", f"Smough's Gauntlets", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110873, f"Domhnall of Zena After O+S: Smough's Leggings", f"Smough's Leggings", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110874, f"Domhnall of Zena After O+S: Ornstein's Helm", f"Ornstein's Helm", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110875, f"Domhnall of Zena After O+S: Ornstein's Armor", f"Ornstein's Armor", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110876, f"Domhnall of Zena After O+S: Ornstein's Gauntlets", f"Ornstein's Gauntlets", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110877, f"Domhnall of Zena After O+S: Ornstein's Leggings", f"Ornstein's Leggings", DSRLocationCategory.SHOP_ITEM),
],
"Firelink Shrine - Domhnall of Zena After Gwyndolin": [
    DSRLocationData(11110878, f"Domhnall of Zena After Gwyndolin: Crown of the Dark Sun", f"Crown of the Dark Sun", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110879, f"Domhnall of Zena After Gwyndolin: Moonlight Robe", f"Moonlight Robe", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110880, f"Domhnall of Zena After Gwyndolin: Moonlight Gloves", f"Moonlight Gloves", DSRLocationCategory.SHOP_ITEM),
    DSRLocationData(11110881, f"Domhnall of Zena After Gwyndolin: Moonlight Waistcloth", f"Moonlight Waistcloth", DSRLocationCategory.SHOP_ITEM),
],
# # "Firelink Shrine - Domhnall of Zena After Gwyn": [
...
"Upper Undead Burg - Male Undead Merchant": [
    ...
    DSRLocationData(11111064, f"Male Undead Merchant: Dagger", f"Dagger", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111065, f"Male Undead Merchant: Shortsword", f"Shortsword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111066, f"Male Undead Merchant: Scimitar", f"Scimitar", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111067, f"Male Undead Merchant: Rapier", f"Rapier", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111068, f"Male Undead Merchant: Hand Axe", f"Hand Axe", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111069, f"Male Undead Merchant: Club", f"Club", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111070, f"Male Undead Merchant: Reinforced Club", f"Reinforced Club", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111071, f"Male Undead Merchant: Spear", f"Spear", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111072, f"Male Undead Merchant: Short Bow", f"Short Bow", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111073, f"Male Undead Merchant: East-West Shield", f"East-West Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111074, f"Male Undead Merchant: Small Leather Shield", f"Small Leather Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111075, f"Male Undead Merchant: Buckler", f"Buckler", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111076, f"Male Undead Merchant: Leather Shield", f"Leather Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111077, f"Male Undead Merchant: Heater Shield", f"Heater Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111078, f"Male Undead Merchant: Warrior's Round Shield", f"Warrior's Round Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111079, f"Male Undead Merchant: Chain Helm", f"Chain Helm", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111080, f"Male Undead Merchant: Chain Armor", f"Chain Armor", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111081, f"Male Undead Merchant: Leather Gauntlets", f"Leather Gauntlets", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111082, f"Male Undead Merchant: Chain Leggings", f"Chain Leggings", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Upper Undead Burg - Taurus Demon": [
...
"Undead Parish - Andre of Astora": [
    ...
    DSRLocationData(11111099, f"Andre of Astora: Longsword", f"Longsword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111100, f"Andre of Astora: Broadsword", f"Broadsword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111101, f"Andre of Astora: Bastard Sword", f"Bastard Sword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111102, f"Andre of Astora: Battle Axe", f"Battle Axe", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111103, f"Andre of Astora: Warpick", f"Warpick", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111104, f"Andre of Astora: Caestus", f"Caestus", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111105, f"Andre of Astora: Pike", f"Pike", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111106, f"Andre of Astora: Large Leather Shield", f"Large Leather Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111107, f"Andre of Astora: Tower Kite Shield", f"Tower Kite Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111108, f"Andre of Astora: Caduceus Kite Shield", f"Caduceus Kite Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Undead Parish - Bell Gargoyles": [
...
"Undead Parish - Oswald of Carim": [
    ...
    DSRLocationData(11111120, f"Oswald of Carim: Indictment", f"Filler", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111121, f"Oswald of Carim: Velka's Talisman", f"Velka's Talisman", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Firelink Shrine - After Undead Parish Elevator": [
...
"Sen's Fortress - Crestfallen Merchant": [
    ...
    DSRLocationData(11111083, f"Crestfallen Merchant: Greatsword", f"Greatsword", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111084, f"Crestfallen Merchant: Greataxe", f"Greataxe", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111085, f"Crestfallen Merchant: Balder Shield", f"Balder Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111086, f"Crestfallen Merchant: Tower Shield", f"Tower Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111087, f"Crestfallen Merchant: Catarina Helm", f"Catarina Helm", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111088, f"Crestfallen Merchant: Catarina Armor", f"Catarina Armor", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111089, f"Crestfallen Merchant: Catarina Gauntlets", f"Catarina Gauntlets", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111090, f"Crestfallen Merchant: Catarina Leggings", f"Catarina Leggings", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111091, f"Crestfallen Merchant: Steel Helm", f"Steel Helm", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111092, f"Crestfallen Merchant: Steel Armor", f"Steel Armor", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111093, f"Crestfallen Merchant: Steel Gauntlets", f"Steel Gauntlets", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111094, f"Crestfallen Merchant: Steel Leggings", f"Steel Leggings", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111095, f"Crestfallen Merchant: Balder Helm", f"Balder Helm", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111096, f"Crestfallen Merchant: Balder Armor", f"Balder Armor", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111097, f"Crestfallen Merchant: Balder Gauntlets", f"Balder Gauntlets", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111098, f"Crestfallen Merchant: Balder Leggings", f"Balder Leggings", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Sen's Fortress - Iron Golem": [
...
"Anor Londo - Giant Blacksmith": [
    ...
    DSRLocationData(11111122, f"Giant Blacksmith: Giant's Halberd", f"Giant's Halberd", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111123, f"Giant Blacksmith: Giant Shield", f"Giant Shield", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111124, f"Giant Blacksmith: Giant Helm", f"Giant Helm", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111125, f"Giant Blacksmith: Giant Armor", f"Giant Armor", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111126, f"Giant Blacksmith: Giant Gauntlets", f"Giant Gauntlets", DSRLocationCategory.SHOP_EXTENDED_ITEM),
    DSRLocationData(11111127, f"Giant Blacksmith: Giant Leggings", f"Giant Leggings", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Anor Londo - Ornstein and Smough": [
...
"Upper New Londo Ruins - Rickert of Vinheim": [
    ...
    DSRLocationData(11111117, f"Rickert of Vinheim: Sorcerer's Catalyst", f"Sorcerer's Catalyst", DSRLocationCategory.SHOP_EXTENDED_ITEM),
],
"Upper New Londo Ruins - After Fog": [
