...
ITEMS_DATA: dict[str, dict[str, Any]] = {
    ...
    "Bomb Bag": {
        ...
        'item_groups': ["Equipment", "Main Items", "Ammo Items", "Bombs"],
        "variant_prog": ["Bombs (Progressive)", "Bomb Bag", "Bomb Bag Upgrade"],
    ...
    "Bomb Bag Upgrade": {
        'classification': ItemClassification.progression,
        "progressive": [[STAddr.bomb_capacity, 0x1], [STAddr.bomb_capacity, 0x2]],
        "tags": ["progressive_overwrite"],
        "give_ammo": [20, 30],
        "ammo_address": STAddr.bomb_count,
        'item_groups': ["Equipment", "Ammo Items", "Bombs", "Upgrade Items"],
        "variant_prog": ["Bombs (Progressive)", "Bomb Bag", "Bomb Bag Upgrade"],

        "model": "Medium Bomb Bag",
        "progressive_model": ["Medium Bomb Bag", "Large Bomb Bag"],
        "id": 9,
    },
    "Bow (Progressive)": {
        'classification': ItemClassification.progression,
    ...
    "Bow": {
        ...
        "give_ammo": [20],
        "ammo_address": STAddr.arrow_count,
        'item_groups': ["Equipment", "Main Items", "Bows", "Ammo Items"],
        "variant_prog": ["Bow (Progressive)", "Bow", "Quiver Upgrade"],
    ...
    "Quiver Upgrade": {
        'classification': ItemClassification.progression,
        "progressive": [[STAddr.arrow_capacity, 0x1], [STAddr.arrow_capacity, 0x2]],
        "give_ammo": [30, 50],
        "ammo_address": STAddr.arrow_count,
        "tags": ["progressive_overwrite"],
        'item_groups': ["Equipment", "Bows", "Ammo Items", "Quiver", "Upgrade Items"],
        "variant_prog": ["Bow (Progressive)", "Bow", "Quiver Upgrade"],

        "model": "Medium Quiver",
        "progressive_model": ["Medium Quiver", "Large Quiver"],
        "id": 12,
    },
    "Bow of Light": {
        'classification': ItemClassification.progression,
    ...
    "Forest Glyph": {
        ...
        'value': 0x80,
        'item_groups': ["Glyphs", "Rail Items", "Forest Tracks", "Major Forest Track", "Tracks: Forest Glyph"],
        'model': "Forest Glyph",
        "reload_entrances": [0x2F00],
        "id": 43,
    },
    "Snow Glyph": {
        ...
        'value': 0x01,
        'item_groups': ["Glyphs", "Rail Items", "Snow Tracks", "Major Snow Track", "Tracks: Snow Glyph"],
        'model': "Snow Glyph",
        "id": 44,
    },
    "Ocean Glyph": {
        ...
        'address': STAddr.adv_flags_2,
        'value': 0x02,
        'item_groups': ["Glyphs", "Rail Items", "Ocean Realm Tracks", "Major Ocean Track", "Tracks: Ocean Glyph"],
        'model': "Ocean Glyph",
        "id": 45,
    },
    "Fire Glyph": {
        ...
        'address': STAddr.adv_flags_2,
        'value': 0x04,
        'item_groups': ["Glyphs", "Rail Items", "Fire Tracks", "Major Fire Track", "Tracks: Fire Glyph"],
        'model': "Fire Glyph",
        "id": 46,
    },
    "Wooded Temple Tracks": {
        ...
        'item_groups': ["Restoration Tracks", "Rail Items", "Forest Tracks",
                        "Forest Restoration", "Forest Realm Restoration", "Major Forest Track",
    ...
    "Blizzard Temple Tracks": {
        ...
        'item_groups': ["Restoration Tracks", "Rail Items", "Snow Tracks",
                        "Snow Restoration", "Snow Realm Restoration", "Major Snow Track",
    ...
    "Marine Temple Tracks": {
        ...
        'item_groups': ["Restoration Tracks", "Rail Items", "Ocean Realm Tracks",
                        ...
                        "Major Ocean Track", "Tracks: Marine Temple Tracks"],
        'model': "Ocean Glyph 2",
        "id": 49,
    },
    "Mountain Temple Tracks": {
        ...
        'address': STAddr.rail_restorations,
        'value': 0x10,
        'item_groups': ["Restoration Tracks", "Rail Items", "Fire Tracks", "Major Fire Track"
    ...
    "Desert Temple Tracks": {
        ...
        'address': STAddr.rail_restorations,
        'value': 0x20,
        'item_groups': ["Restoration Tracks", "Rail Items", "Desert Tracks", "Major Sand Track"
    ...
    "Snowdrift Station Tracks": {
        ...
        'item_groups': ["Rail Items", "Snow Tracks", "Misc Tracks",
                        "Snowdrift Tracks", "Minor Snow Track", "Tracks: Snowdrift Station"],
        "model": "Snow Glyph",
    ...
    "Slippery Station Tracks": {
        ...
        'value': 0x20,
        'item_groups': ["Rail Items", "Snow Tracks", "Misc Tracks",
                        "Slippery Tracks", "Minor Snow Track", "Tracks: Slippery Station"],
        "model": "Snow Glyph",
    ...
    "Pirate Hideout Tracks": {
        ...
        'item_groups': ["Rail Items", "Ocean Realm Tracks", "Misc Tracks",
                        "Minor Ocean Track", "Tracks: Pirate Hideout"],
        "model": "Ocean Glyph",
    ...
    "Lost at Sea Station Tracks": {
        ...
        'address': STAddr.tracks_1,
        'value': 0x40,
        'item_groups': ["Rail Items", "Ocean Realm Track", "Misc Tracks",
    ...
    "Forest Realm Ocean Shortcut Tracks": {
        ...
        'item_groups': ["Rail Items", "Forest Tracks", "Ocean Realm Tracks", "Misc Tracks",
                        "Minor Forest Track", "Minor Ocean Track", "Tracks: Forest Realm Ocean Shortcut"],
        "model": "Ocean Glyph",
    ...
    "E Mayscore Bridge Tracks": {
        ...
        'address': STAddr.tracks_0,
        'value': 0x04,
        'item_groups': ["Rail Items", "Forest Tracks", "Misc Tracks", "Minor Forest Track",
    ...
    "W Castle Town Tracks": {
        ...
        'address': STAddr.tracks_0,
        'value': 0x20,
        'item_groups': ["Rail Items", "Forest Tracks", "Misc Tracks", "Minor Forest Track", "Tracks: W Castle Town"],
        "model": "Forest Glyph",
    ...
    "W Forest Realm Tracks": {
        ...
        'address': STAddr.tracks_0,
        'value': 0x40,
        'item_groups': ["Rail Items", "Forest Tracks", "Misc Tracks", "Minor Forest Track", "Tracks: W Forest Realm"],
        "model": "Forest Glyph",
    ...
    "W Wooded Temple Tracks": {
        ...
        'item_groups': ["Rail Items", "Forest Tracks", "Snow Tracks", "Misc Tracks",
                        "Minor Snow Track", "Minor Forest Tracks", "Tracks: W Wooded Temple"],
        "model": "Forest Glyph",
    ...
    "N Castle Town Tracks": {
        ...
        'value': 0x02,
        'item_groups': ["Rail Items", "Forest Tracks", "Snow Tracks", "Misc Tracks",
                        "Minor Snow Track", "Minor Forest Track", "Tracks: N Castle Town"],
        "model": "Forest Glyph",
    ...
    "Snow Realm Bridge Tracks": {  # has portal to ocean realm
        ...
        'value': 0x08,
        'item_groups': ["Rail Items", "Forest Tracks", "Snow Tracks", "Misc Tracks",
                        "Minor Snow Track", "Minor Forest Track", "Tracks: Snow Realm Bridge"],
        "model": "Snow Glyph",
    ...
    "N Icy Spring Tracks": {
        ...
        'address': STAddr.tracks_1,
        'value': 0x10,
        'item_groups': ["Rail Items", "Snow Tracks", "Misc Tracks", "Minor Snow Track", "Tracks: N Icy Spring"],
        "model": "Snow Glyph",
    ...
    "Ocean Portal Tracks": {
        ...
        'address': STAddr.tracks_1,
        'value': 0x80,
        'item_groups': ["Rail Items", "Ocean Realm Tracks", "Misc Tracks", "Minor Ocean Track",
                        "Tracks: Ocean Portal"],
        "model": "Ocean Glyph",
    ...
    "Sand Realm Tracks": {
        ...
        'address': STAddr.tracks_2,
        'value': 0x20,
        'item_groups': ["Rail Items", "Desert Tracks", "Misc Tracks", "Major Sand Track", "Tracks: Sand Realm"],
        "id": 67,
        "model": "Ocean Glyph"
    },
    "Fire Realm Sand Portal Tracks": {
        ...
        'item_groups': ["Rail Items", "Desert Tracks", "Fire Tracks", "Misc Tracks",
                        ...
                        "Minor Fire Track", "Minor Sand Track", "Tracks: Fire Realm Sand Portal"],
        "model": "Fire Glyph",
    ...
    "Dark Ore Mine Tracks": {
        ...
        'value': 0x04,
        'item_groups': ["Rail Items", "Desert Tracks", "Fire Tracks", "Misc Tracks",
                        "Minor Sand Track", "Minor Fire Track", "Tracks: Dark Ore Mine"],
        "model": "Fire Glyph",
    ...
    "Ends of the Earth Tracks": {
        ...
        'address': STAddr.tracks_0,
        'value': 0x10,
        'item_groups': ["Rail Items", "Fire Tracks", "Misc Tracks", "Minor Fire Track", "Tracks: Ends of the Earth"],
        "model": "Fire Glyph",
    ...
    "Disorientation Station Tracks": {
        ...
        'item_groups': ["Rail Items", "Fire Tracks", "Misc Tracks",
                        "Disorientation Tracks", "Minor Fire Track", "Tracks: Disorientation Station"],
        "model": "Fire Glyph",
    ...
    "Snow Realm Gorge Tracks": {
        ...
        'item_groups': ["Rail Items", "Snow Tracks", "Fire Tracks", "Misc Tracks",
                        ...
                        "Minor Snow Track", "Minor Fire Track", "Tracks: Snow Realm Gorge"],
        "model": "Fire Glyph",
    ...
    "Forest Source": {
        ...
        'item_groups': ["Rail Items", "Sources", "Forest Tracks", "Major Forest Track", "Tracks: Forest Source"],
        'model': "Forest Glyph",
    ...
    "Snow Source": {
        ...
        'item_groups': ["Rail Items", "Sources", "Snow Tracks", "Major Snow Track", "Tracks: Snow Source"],
        'model': "Snow Glyph",
        "reload_entrances": [0x1400, 0x1401, 0x1700],
        "id": 74,
    },
    "Ocean Source": {
        ...
        'item_groups': ["Rail Items", "Sources", "Ocean Realm Tracks", "Major Ocean Track", "Tracks: Ocean Source"],
        'model': "Ocean Glyph",
        "reload_entrances": [0x1400, 0x1401, 0x1700],
        "id": 75,
    },
    "Fire Source": {
        ...
        'item_groups': ["Rail Items", "Sources", "Fire Tracks", "Major Fire Track", "Tracks: Fire Source"],
        'model': "Fire Glyph",
        "reload_entrances": [0x1400, 0x1401, 0x1700],
        "id": 76,
    },
    "Sand Source": {  # Only used for TEAO3 unlock?
        ...
        'item_groups': ["Sources", "Major Sand Track", "Tracks: Sand Source"],
        'model': "Ocean Glyph",
...
ITEMS_DATA |= {
    ...
    for i, n in enumerate(list(range(2, 6)) + [10], start=0) for j, realm in
    enumerate(["Grass", "Snow", "Ocean", "Mountain", "Sand"], start=83)
}
