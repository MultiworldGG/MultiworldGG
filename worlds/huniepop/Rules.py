...
def set_rules(multiworld, player, girls, girldata, goal, progdate):
    ...
    for girl in girls:
        ...
        if progdate:
            forbid_item(multiworld.get_location(f"{girl} date 1", player), "Date Pass", player)
            forbid_item(multiworld.get_location(f"{girl} date 2", player), "Date Pass", player)
            forbid_item(multiworld.get_location(f"{girl} date 3", player), "Date Pass", player)
            forbid_item(multiworld.get_location(f"{girl} date 4", player), "Date Pass", player)
            forbid_item(multiworld.get_location(f"Slept with {girl}", player), "Date Pass", player)

            if not is_ut:
                set_rule(multiworld.get_location(f"{girl} date 1", player), lambda state: state.has("Date Pass", player, 1))
                set_rule(multiworld.get_location(f"{girl} date 2", player), lambda state: state.has("Date Pass", player, 2))
                set_rule(multiworld.get_location(f"{girl} date 3", player), lambda state: state.has("Date Pass", player, 3))
                set_rule(multiworld.get_location(f"{girl} date 4", player), lambda state: state.has("Date Pass", player, 4))
                set_rule(multiworld.get_location(f"Slept with {girl}", player), lambda state: state.has("Date Pass", player, 5))
