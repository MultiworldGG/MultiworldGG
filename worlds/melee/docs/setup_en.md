# Super Smash Bros. Melee MultiworldGG Randomizer Setup Guide
...
files. Your patch file should have a `.zip` extension, containing an `.xml` file.
...
Launch the Super Smash Bros. Melee Client from the MultiworldGG Launcher. If your game is running from the previous step, it should automatically connect.
