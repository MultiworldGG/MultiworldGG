...
- ScummVM 2026.2.0 64-bit ([Direct Download](https://downloads.scummvm.org/frs/scummvm/2026.2.0/scummvm-2026.2.0-win32-x86_64.zip))
- MultiworldGG 0.7.100+


## Game Setup Instructions

No game modding is required to play Zork Grand Inquisitor with MultiworldGG. The client included with the APWorld does all the work by attaching to the game process and reading and manipulating the game state in real-time. The instructions assume the game is already installed.
...
- Your game is now ready to be played with MultiworldGG. From now on, you can use the `Launch Zork Grand Inquisitor` shortcut to launch the game.
...
- Download the latest _Windows_ release of MultiworldGG (.exe file).
...
```batch
start C:\Program Files\MultiworldGG\MultiworldGGLauncher.exe "Zork Grand Inquisitor Client"
.\scummvm.exe
```
- Run your newly created batch file. Both ScummVM and the Zork Grand Inquisitor MultiworldGG Client should open.
- This is how you will launch everything to play the MultiworldGG version of Zork Grand Inquisitor on Linux from this point forward.


## Joining a Multiworld Game

- Launch Zork Grand Inquisitor and start a new game. Skip or wait for the cinematic to finish.
- Open the MultiworldGG Launcher. Find and click `Zork Grand Inquisitor Client`.
