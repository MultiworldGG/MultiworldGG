...
region_packs: typing.Dict[str, RegionsData] = {
    ...
    "open": RegionsData(
        ...
        region_connections = [
            ...
            RegionConnection(region_from='open14.1', region_to='open14.2', cond=[ItemCondition(item_name="So'najiz Key", amount=3)]),
            RegionConnection(region_from='open14.2', region_to='open14.3', cond=[ItemCondition(item_name="So'najiz Key", amount=4), ItemCondition(item_name='Radiant Key', amount=1)]),
            RegionConnection(region_from='open14.3', region_to='open14.4', cond=[ItemCondition(item_name='Shock', amount=1)]),
