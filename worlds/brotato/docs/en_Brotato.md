...
start. Instead, you will need to find "Progressive Wave Cap (<character>)" items to be
able to play further waves and complete runs with a particular character.
