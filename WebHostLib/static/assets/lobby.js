(function () {
    ...
    function formatMetaOpts(s, g) {
        ...
        return `Release: ${s.release_mode || '?'} | Collect: ${s.collect_mode || '?'} | Threshold: ${threshold}% | Remaining: ${s.remaining_mode || '?'} | Hints: ${hmLabel} @ ${hcLabel} | Item Cheat: ${s.item_cheat ? 'on' : 'off'} | Spoiler: ${spLabel}`;
    }
